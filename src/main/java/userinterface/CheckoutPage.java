...
public class CheckoutPage {
    ...
    public static final Target BTN_REMOVE = Target.the("Button remove").located(AppiumBy.accessibilityId("test-REMOVE"));
    ...
    public static final Target PRODUCT_NAME = Target.the("Nombre del producto")
            .locatedForAndroid(AppiumBy.xpath("//android.widget.TextView[@text='Sauce Labs Backpack']"))
            .locatedForIOS(AppiumBy.accessibilityId("Sauce Labs Backpack"));
}
